defmodule Contents.FrameEncoder do
  ...
  def encode_frame(commands, camera, ui, mesh_definitions, cursor_grab \\ nil, audio_cues \\ []) do
    frame =
  ...
  defp command_to_pb(command) do
    raise ArgumentError,
          "unknown DrawCommand #{inspect(command)}. Add a clause or update alchemy-protocol render_frame schema (PROTOCOL_PIN)"
  end
