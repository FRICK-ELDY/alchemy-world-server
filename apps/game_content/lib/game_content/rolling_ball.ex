defmodule GameContent.RollingBall do
  @moduledoc """
  ローリングボール迷路コンテンツ。
  ...
  def components do
    [
      GameContent.RollingBall.SpawnComponent,
      GameContent.RollingBall.PhysicsComponent,
      GameContent.RollingBall.RenderComponent
    ]
  end
  ...
  def initial_scenes do
    [%{module: GameContent.RollingBall.Scenes.Title, init_arg: %{}}]
  end
  ...
  def playing_scene, do: GameContent.RollingBall.Scenes.Playing
  def game_over_scene, do: GameContent.RollingBall.Scenes.GameOver
