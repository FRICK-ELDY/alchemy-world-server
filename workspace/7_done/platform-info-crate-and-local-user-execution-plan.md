...
※ `native/client` の作成は [env-and-serialization-migration-plan](../1_backlog/env-and-serialization-migration-plan.md) §5 に従う。
...
※ `native/client` は [env-and-serialization-migration-plan](../1_backlog/env-and-serialization-migration-plan.md) §5 に従い作成。`client_desktop` は `client` に依存する。
...
| 順序  | フェーズ               | 内容                                                                              | 状態 |
| --- | ------------------ | ------------------------------------------------------------------------------- | --- |
| 1   | native/client 作成     | `client` クレート作成、`info` モジュール（`src/info.rs`）追加（[env-and-serialization-migration-plan](../1_backlog/env-and-serialization-migration-plan.md) §5 参照） | ✅ 完了 |
...
- [env-and-serialization-migration-plan](../1_backlog/env-and-serialization-migration-plan.md) — native/client 作成・client_info・client_* 依存整理（§5）
