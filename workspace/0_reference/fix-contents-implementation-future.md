...
- 既存 LocalUserComponent 等の components 層への移行（[contents-components-reorganization-procedure.md](../1_backlog/contents-components-reorganization-procedure.md) と整合を取る）
