...
> 元計画: [env-and-serialization-migration-plan.md](../current/env-and-serialization-migration-plan.md)  
> 実施完了: 2026-03 頃  
...
- [erlang-term-schema.md](../../architecture/erlang-term-schema.md)
- [messagepack-schema.md](../../architecture/messagepack-schema.md)
