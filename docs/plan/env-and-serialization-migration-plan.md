...
- ポリシー: [zenoh-frame-serialization.md](../policy/zenoh-frame-serialization.md) で Erlang term 形式を採用
...
- [zenoh-frame-serialization.md](../policy/zenoh-frame-serialization.md) — Erlang term 採用ポリシー
