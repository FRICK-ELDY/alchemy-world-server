...
> 作成日: 2026-03-12  
> 参照: [fix_contents.md](../architecture/fix_contents.md)、[fix-contents-implementation-procedure.md](./fix-contents-implementation-procedure.md)  
...
- [fix-contents-implementation-procedure.md](./fix-contents-implementation-procedure.md) — 実施手順
