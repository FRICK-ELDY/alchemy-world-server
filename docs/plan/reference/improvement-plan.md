...
- [client-server-separation-procedure.md](../completed/client-server-separation-procedure.md) — クライアント・サーバー分離（zenohd トレイ統合、未実施項目は [client-server-separation-future.md](client-server-separation-future.md)）
...
- [client-server-separation-procedure.md](../completed/client-server-separation-procedure.md)（未実施項目は [client-server-separation-future.md](client-server-separation-future.md)）
