...
- **Contents.SceneStack・GameEvents のテスト欠如** — シーン遷移・フレームループの中核ロジックが未検証
...
- **SceneStack・GameEvents のテストがゼロ** `-3`
...
1. **Contents.SceneStack・GameEvents のテスト整備** — シーン遷移・フレームループの中核ロジックを検証する
