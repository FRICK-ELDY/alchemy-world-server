...
引き続き **[improvement-plan.md](../../workspace/0_reference/improvement-plan.md)** に沿い、**SceneStack / Events.Game のユニットテスト**、**EntityParams の SSoT 化**、**ネットワーク層と描画層の依存整理**を優先すると、ビジョン（[vision.md](../vision.md)）との整合と保守性がさらに上がる。
