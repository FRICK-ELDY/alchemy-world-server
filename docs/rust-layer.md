...
```mermaid
graph LR
    GN[nif<br/>NIF インターフェース<br/>ゲームループ / レンダーブリッジ]
    GS[physics<br/>物理 / ECS<br/>依存: rustc-hash / rayon / log]
    GR[render<br/>wgpu 描画 / winit ウィンドウ<br/>ヘッドレスモード対応]
    GA[audio<br/>rodio オーディオ]
