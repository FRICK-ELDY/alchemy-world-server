...
// Golden fixture generated by Elixir Content.FrameEncoder.encode_frame/5.
// Regenerate:
//   1) create a temporary Mix script that builds the same commands/camera/ui/mesh payload
//   2) write bytes to native/network/tests/fixtures/render_frame_elixir_golden.bin
//   3) rerun this test and update assertions if schema intentionally changed
